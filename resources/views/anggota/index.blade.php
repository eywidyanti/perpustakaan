			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
                        ...
                        <h4 class= "ml-3">Daftar Anggota</h6>
						<div class="container mt-4">
						<a href="{{url('/anggotas/create')}}" class="btn btn-primary">
						<i class="la la-user-plus"> Tambah Anggota</i></a>
							@if(session()->has('pesan'))
							<div class="alert alert-success" role="alert">
							...
							<div class="row">
								<div class="col-9"></div>
								<div class="col-3">
									<form method="GET" class="navbar-left navbar-form nav-search mr-md-3" action="{{url('/anggota') }}">
                        ...
                        <table class="table table-striped ml-5 mr-5 mt-3">
                            ...
                            <tbody> 
                                ...
                                <tr> 
                                    ...
                                    <td>{{$anggota->email}}</td> 
									<td>
										<img src="{{asset('img')}}/{{$anggota->foto}}" alt="" width="100px">
									</td>
									<td>{{$anggota->telp}}</td>
                                </tr>
                            @empty
