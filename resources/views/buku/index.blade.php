				...
				<div class="container-fluid">
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<a class="dropdown-toggle profile-pic" data-toggle="dropdown" aria-expanded="false"> <img src="{{asset('img')}}/{{ Auth::user()->foto }}" alt="user-img" width="45" height="45" class="img-circle"><span>{{ Auth::user()->name }}</span></span> </a>
                            <ul class="dropdown-menu dropdown-buku">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
                        ...
                        <h4 class= "ml-3">Daftar Buku</h6>
						<div class="container mt-4">
						<a href="{{url('/bukus/create')}}" class="btn btn-primary">
						<i class="la la-user-plus"> Tambah Buku</i></a>
							@if(session()->has('pesan'))
							<div class="alert alert-success" role="alert">
							...
							<div class="row">
								<div class="col-9"></div>
								<div class="col-3">
									<form method="GET" class="navbar-left navbar-form nav-search mr-md-3" action="{{url('/buku') }}">
                        ...
                        <table class="table table-striped ml-5 mr-5 mt-3">
                            ...
                            <tbody> 
                                ...
                                <tr> 
                                    ...
                                    <td>{{$buku->email}}</td> 
									<td>
										<img src="{{asset('img')}}/{{$buku->foto}}" alt="" width="100px">
									</td>
									<td>{{$buku->telp}}</td>
                                </tr>
                            @empty
